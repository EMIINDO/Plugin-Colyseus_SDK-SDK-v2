...

{
    ...
    globalThis.C3.Plugins.Colyseus_SDK.Instance = class ColyseusInstance extends globalThis.ISDKWorldInstanceBase {
        constructor() {
            super();
        ...
        _MatchMake(methodName, roomName, rawOptions) {
            ...
            this.client[methodName](...args).then(function (room) {
                ...
                self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnJoinRoom);

                room.onError(function (code, message) {
                    self.lastError = { code: code, message: message };
                    self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnRoomError);
                    self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnAnyError);
                });

                room.onLeave(function (code) {
                    self.lastCloseCode = code;
                    self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnLeaveRoom);
                });
                ...
                room.onStateChange.once(function () {
                    ...
                    function onChangeAtPath(key, path, value, previousValue) {
                        ...
                        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnChangeAtPath);
                    }
                    ...
                    function onItemAdd(path, instance, key) {
                        ...
                        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnChangeAtPath);
                        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnCollectionItemAdd);
                    }
                    ...
                    function onItemChange(path, instance, key) {
                        ...
                        self.lastKey = key;
                        self.lastValue = instance;
                        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnCollectionItemChange);
                    }
                    ...
                    function onItemRemove(path, instance, key) {
                        ...
                        self.lastKey = key;
                        self.lastValue = instance;
                        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnCollectionItemRemove);
                    }
                ...
                room.onStateChange(function (state) {
                    ...
                    self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnStateChange);
                });
                ...
                room.onMessage("*", function (type, message) {
                    ...
                    self.lastType = type;
                    self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnMessage);
                });
                ...
                self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnJoinError);
                self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnAnyError);
            });
        }
