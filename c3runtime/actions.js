...

{
  ...
  globalThis.C3.Plugins.Colyseus_SDK.Acts =
  {
    ...
    {
      globalThis.C3.Plugins.Colyseus_SDK.Acts.RoomSend.call(this, type, JSON.parse(message));
    },
    ...
    GetAvailableRooms(roomName)
    {
      ...
      this.client.getAvailableRooms(roomName).then(rooms => {
        ...
        self._trigger(globalThis.C3.Plugins.Colyseus_SDK.Cnds.OnGetAvailableRooms);
      }).catch(function(err) {
        if (self.debug)
        {
